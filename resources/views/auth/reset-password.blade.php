            ...
            <div class="w-full lg:w-1/2 bg-white flex items-center justify-center px-6 py-8 lg:px-12 lg:py-16">
                <div class="w-full max-w-md">
                    ...
                    <div class="lg:hidden flex flex-col items-center mb-6">
                        ...
                        <h2 class="text-xl font-bold text-slate-800 tracking-wider">RESET PASSWORD</h2>
                    </div>
                    ...
                    <form method="POST" action="{{ route('password.store') }}" class="space-y-4 lg:space-y-5">
                        ...
                        <div class="mt-5 lg:mt-6">
                            <button
                                type="submit"
                                class="w-full py-3 lg:py-4 bg-slate-800 text-white border-none rounded-lg lg:rounded-xl text-xs lg:text-sm font-bold uppercase tracking-[0.2em] cursor-pointer transition-all duration-300 hover:bg-slate-700 hover:shadow-xl hover:shadow-slate-800/30 active:translate-y-0.5"
                            >
                                RESET PASSWORD
                            </button>
                        </div>
