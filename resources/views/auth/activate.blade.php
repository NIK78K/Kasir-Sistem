<x-guest-layout>
    ...
    <div class="flex w-full max-w-4xl bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-800 to-slate-900 flex-col items-center justify-center px-12 py-16 relative overflow-hidden">
            ...
            <!-- Activation Title -->
            <div class="text-white text-4xl font-bold uppercase tracking-[0.2em] relative z-10 mb-4 text-center">AKTIVASI AKUN</div>

            <!-- Subtitle -->
            <p class="text-slate-300 text-base relative z-10 text-center">Aktifkan akun Anda untuk melanjutkan</p>
        </div>
        ...
        <div class="w-full lg:w-1/2 bg-white flex items-center justify-center px-8 py-12 lg:px-12 lg:py-16">
            <div class="w-full max-w-md">
                ...
                <div class="lg:hidden flex flex-col items-center mb-8">
                    ...
                    <h2 class="text-2xl font-bold text-slate-800 tracking-wider">AKTIVASI AKUN</h2>
                </div>
                ...
                <form method="POST" action="{{ route('user.activate.store') }}" class="space-y-5">
                    @csrf
                    ...
                    <div class="relative">
                        <div class="relative flex items-stretch border-2 border-slate-200 rounded-xl transition-all duration-300 overflow-hidden bg-slate-50">
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-slate-600">
                        Sudah memiliki akun? <a href="{{ route('login') }}" class="text-slate-800 hover:text-slate-700 font-semibold">Login di sini</a>
                    </p>
                </div>
            </div>
        </div>
